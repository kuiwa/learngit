...
{
	var unit_id     = "718482";
	var client_ip   = "134.159.210.70";
	var server_time = "1414996501";
	var verify_code = "58ec2635";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var open_url="http://"+icon_link_host+"/note.html?unit_id="+unit_id+"&url="+url;
	var open_win="javascript:window.open ('"+open_url+"', 'newwindow', 'height=500, width=600, top=100, left=100, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');";
	document.write( "<a href='#' onClick=\""+open_win+"\">&#32473;&#25105;&#30041;&#35328;</a>" );
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/718482/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
