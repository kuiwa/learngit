...
if __name__ == '__main__':
	...
	filemenu.add_command(label='(N)ew User Login',command=newuser)
	filemenu.add_command(label='(E)xisting User Login',command=olduser)
	filemenu.add_command(label='(S)how User Informations',command=show)
	root['menu'] = menubar
	root.mainloop()
	#showmenu()
	#print loginTime
